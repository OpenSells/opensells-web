    ...
    <section id="how" className="py-20 sm:py-28 bg-slate-50">
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        ...
        <div className="relative">
          <div className="absolute left-8 top-8 bottom-8 w-px bg-brand-200 hidden sm:block" />

          <div className="space-y-8">
            {steps.map((step, i) => (
              <div key={i} className="flex gap-6 items-start">
                <div className="relative flex-shrink-0 w-16 h-16 rounded-2xl bg-brand-500 flex items-center justify-center shadow-md">
