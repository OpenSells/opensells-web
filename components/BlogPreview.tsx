    ...
    <section id="blog" className="py-20 sm:py-28 bg-slate-50">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-12">
          ...
          <Link
            href={blogBase}
            className="flex-shrink-0 inline-flex items-center gap-1.5 text-sm font-semibold text-brand-600 hover:text-brand-700 transition-colors"
          >
            {t('cta')}
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          {posts.map((post) => (
            <Link
              ...
              className="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:border-brand-200 hover:shadow-md transition-all"
            >
              ...
              <h3 className="font-bold text-slate-900 text-base leading-snug group-hover:text-brand-600 transition-colors mb-2">
                {post.title}
              </h3>
