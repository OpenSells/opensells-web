                ...
                <div className="mb-6">
                  ...
                  {isFree ? (
                    <div className="flex items-end gap-1">
                      ...
                      <span className={`text-sm mb-1 ${isPopular ? 'text-brand-100' : 'text-slate-400'}`}>{t('per_month')}</span>
                    </div>
                  ) : (
                    <div>
                      <div className="flex items-baseline gap-2 mb-1">
                        ...
                        <span className={`text-sm line-through ${isPopular ? 'text-brand-200' : 'text-slate-400'}`}>
                          €{originalPrice}
                        </span>
                      </div>
